<template>
  <h1 class="mb-8 font-bold text-3xl">Inici</h1>

  <div class="grid grid-cols-3 gap-4 content-center justify-center">
  ...
  <div class="grid grid-cols-4 gap-4 content-center justify-center">
    <div class="grid content-center justify-center md:col-span-2">
      <h3 class="my-8 font-medium text-2xl">Usuaris amb permisos</h3>
      <Table
