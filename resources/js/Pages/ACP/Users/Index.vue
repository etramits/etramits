<template>
  ...
  <h1 class="mb-8 text-3xl font-bold text-zinc-700">Usuaris</h1>
  ...
  <div class="mb-6 flex justify-between items-center">
    ...
    <Link href="/acp/usuaris/crear" class="px-6 py-3 text-sm font-bold text-white leading-4 rounded shadow bg-zinc-700 whitespace-nowrap hover:bg-zinc-800 focus:outline-none focus:ring focus:ring-zinc-700/20">
      <span>Crear</span> <span class="hidden md:inline">Usuari</span>
    </Link>
  </div>
...
<script setup>
      ...
      return {
        ...
        values: [
          ...
          user.email_verified_at
            ...
            : '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="red" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" /><line x1="3" y1="3" x2="21" y2="21" /><path d="M10.584 10.587a2 2 0 0 0 2.828 2.83" /><path d="M9.363 5.365a9.466 9.466 0 0 1 2.637 -.365c4 0 7.333 2.333 10 7c-.778 1.361 -1.612 2.524 -2.503 3.488m-2.14 1.861c-1.631 1.1 -3.415 1.651 -5.357 1.651c-4 0 -7.333 -2.333 -10 -7c1.369 -2.395 2.913 -4.175 4.632 -5.341" />',
  ...
  watch(search, debounce(function (value) {
    Inertia.get("/acp/usuaris", { search: value }, {
      preserveState: true,
      replace: true,
    });
  }, 500));
