<template>
    <jet-form-section @submitted="updatePassword">
        ...
        <template #description>
            Assegureu-vos que el vostre compte utilitzi una contrasenya llarga i aleatòria per mantenir-se segur.
        </template>

        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="current_password" value="Contrasenya actual" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label for="password" value="Contrasenya nova" />
