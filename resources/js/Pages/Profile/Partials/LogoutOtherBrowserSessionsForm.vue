    ...
    <jet-action-section>
        ...
        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Gestioneu i tanqueu la sessió activa en altres navegadors i dispositius.
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div>
                            <div class="text-xs text-gray-500">
                                ...
                                <span class="text-green-500 font-semibold" v-if="session.is_current_device">Aquest dispositiu</span>
                                <span v-else>Últim actiu {{ session.last_active }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Introduïu la vostra contrasenya per confirmar que voleu tancar la sessió de les altres sessions de navegador en tots els vostres dispositius.
