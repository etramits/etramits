        ...
        <template #content>
            ...
            <div class="flex items-center mt-5">
                <jet-button @click="confirmLogout">
                    Tanca la sessió d'altres sessions del navegador
                </jet-button>
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Introduïu la vostra contrasenya per confirmar que voleu tancar la sessió de les altres sessions del vostre navegador a tots els vostres dispositius.
